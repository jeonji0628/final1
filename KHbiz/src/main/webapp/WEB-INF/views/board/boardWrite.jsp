          ...
          <div id="page-inner">  
            ...
            <!-- boardWrite form  -->
            	...
            	<div class="table-responsive2">
	               ...
	               <form action="boardWrite" method="post" id="boardWriteFrom">
					<input type="hidden" name="kind" value="${param.kind}">
	                   ...
	                   <tr>
	                   	...
	                   	<!-- title -->
	                   	<td style="padding-top: 13px;"><input type="text" id="title" class="form-control" name="title"></td>
	                   </tr>
	                   
	                   <tr>
	                   	<!-- contents -->
	                   	<td colspan="2" style="padding-top: 13px;">
	                   		<textarea id="ckeditor" name="contents" rows="10" cols="71"></textarea>
	                   	</td>
	                   </tr>
	               ...
	               <div id="btn_div2">
					<a href="boardList?curPage=1&kind=${param.kind}"><input type="button" id="list" value="취소"></a>
